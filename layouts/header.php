...
<body>
    <header class="sticky sticky-top">
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="#">Pojok Buku</a>
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item ">
                            <div class="dropdown  me-5">
                                <a class="nav-link active" type="button" data-bs-toggle="dropdown" aria-expanded="false" aria-current="page" href="#"><i class="fa-solid fa-user"></i></a>
